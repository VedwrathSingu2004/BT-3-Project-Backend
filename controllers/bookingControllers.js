    ...
    try {
        ...
        if (carResult.rows.length === 0) {
            ...
            return res.status(404).json({
                success: false,
                message: "Car not available or does not exist"
            });
        }
        ...
        const owner_id = carResult.rows[0].owner_id;
        ...
        await client.query(`UPDATE car SET is_available = false WHERE car_id = $1`, [car_id]);
